...
class DoctorWindow(QMainWindow):
    ...
    def _patient_header(self):
        ...
        tag.setStyleSheet("background:#2d3341;color:#c3cad8;border-radius:8px;padding:4px 7px;font-size:11px;font-weight:850;")
        col.addWidget(tag)
        lay.addLayout(col, 1)
    ...
    def _metric_panel(self, title, value, unit, delta, provenance, values, quality_kind="good"):
        ...
        prov.setStyleSheet("border:1px solid #566178;border-radius:6px;padding:3px 7px;color:#aab9ff;font-size:11px;font-weight:800;")
    ...
    def _dashboard_page(self):
        ...
        for icon, title, detail, state in insight_defs:
            ...
            vv = QVBoxLayout()
            tt = QLabel(title)
            tt.setStyleSheet("color:#e8f5ff;font-weight:800;font-size:11px;")
            vv.addWidget(tt)
            dd = QLabel(detail)
        ...
        dev_state.setStyleSheet("color:#45e5b3;font-weight:850;font-size:11px;")
    ...
    def _patient_models(self):
        ...
        for i, (a, b) in enumerate(blocks):
            ...
            v = QVBoxLayout(f)
            h = QLabel(a.upper())
            h.setStyleSheet("color:#e2e6ef;font-weight:850;font-size:11px;")
            v.addWidget(h)
            x = QLabel(b)
            x.setWordWrap(True)
