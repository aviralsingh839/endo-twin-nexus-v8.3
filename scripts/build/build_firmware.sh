...
mkdir -p "$OUT/mega" "$OUT/esp32"

arduino-cli compile --fqbn esp32:esp32:esp32 --export-binaries   --output-dir "$OUT/esp32"   "$ROOT/hardware/esp32/endo_twin_wearable"
