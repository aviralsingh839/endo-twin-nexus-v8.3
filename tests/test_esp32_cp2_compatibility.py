...
def test_esp32_missing_sensor_semantics_are_preserved():
...
def test_active_hardware_paths_do_not_reference_legacy_boards():
    active_files = [
        REPO / "hardware/esp32/endo_twin_wearable/endo_twin_wearable.ino",
