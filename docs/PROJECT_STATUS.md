...
| Area | State |
|---|---|
| Wearable hardware | ESP32-S3-DevKitC-1: MAX30102 PPG, MPU6050 IMU, DS18B20 skin-contact probe, BH1750, BME280. Cardboard enclosure, USB powered (no battery in v1). Build: `docs/CARDBOARD_POD_BUILD.md`, reference: `docs/WEARABLE_AND_MEGA_BUILD_MANUAL.md` |
