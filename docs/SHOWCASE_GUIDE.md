...
- Sensing: MAX30102 PPG HR HRV, MPU6050 motion, DS18B20 temp, ECG, BME280
...
- ECG / BME280 lab-hub channels with their own what/why/signal/limitations MEASURED+DERIVED
...
- Autonomic HRV-based EXPERIMENTAL
- Metabolic multimodal HR HRV activity temp hypothesized EXPERIMENTAL not clinical
...
- Artifact detection: motion MPU6050 correlation PPG amplitude HR outlier temp jumps quality 0-1 per channel source labeling
...
- Autonomic: HRV autonomic regulation
- Variability: HRV RMSSD SDNN pNN50 variability
- Activity: motion activity level day/night
- Temp: skin temp slope circadian
- Metabolic: multimodal HR HRV activity temp hypothesized metabolic regulation experimental not clinical
